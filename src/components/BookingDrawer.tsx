...
//     RedDatePanel below.
// 8-Jul revert: the hourly TimeSlotGrid we tried briefly is out again
// per Suraksha — she prefers the customer to enter the arrival time
// on the manual clock dial only. The already-scheduled cards + the
// server-side overlap guard (in /api/bookings/route.ts) still stop
// double-bookings from actually going through.
function DatePicker({
